...
def figure_1():
    "dessiner une cible"
    # Effacer d'abord tout dessin prÃ©existant :
    can.delete(ALL)
...
def figure_2():
    "dessiner un visage simplifiÃ©"
    # Effacer d'abord tout dessin prÃ©existant :
    can.delete(ALL)
    # Les caractÃ©ristiques de chaque cercle sont
    # placÃ©es dans une liste de listes :
    ...
    # on trace tous les cercles Ã  l'aide d'une boucle :
    i =0
    while i < len(cc):            # parcours de la liste
        el = cc[i]                # chaque Ã©lÃ©ment est lui-mÃªme une liste
...
b3 = Button(fen, text ='Quiter', command =fen.destroy)
